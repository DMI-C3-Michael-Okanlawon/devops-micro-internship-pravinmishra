...
![](screenshots/Wk4-task3-screenshot-3-ls-contact-html.PNG)

---

#### Screenshot 4 — Output of `git commit`

![](screenshots/Wk4-task3-screenshot-4-git-commit-contact-html.PNG)

---

#### Screenshot 5 — Output of `git log --oneline -3` showing the new commit

![alt text](screenshots/Wk4-task3-screenshot-5-gitlog-oneline.PNG)
