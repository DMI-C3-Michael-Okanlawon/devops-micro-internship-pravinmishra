...
![alt text](screenshots/Wk7-A2-SS2-VM-Overview-page.PNG)

---

#### Screenshot 3 — Network Security Group inbound rules showing ports 22 and 80 allowed

![alt text](screenshots/Wk7-A2-SS3-SSH-and-HTTP-Port-Allowed.PNG)
...
![alt text](screenshots/Wk7-A2-SS4-Successful-SSH-Login.PNG)
...
![alt text](screenshots/Wk7-A2-SS5-Node-and-NPM-Output.PNG)
...
![alt text](screenshots/Wk7-A2-SS6-NPM-Run-Build.PNG)
...
![alt text](screenshots/Wk7-A2-SS7-Sudo-Nginx--t.PNG)

---

#### Screenshot 8 — Nginx configuration snippet showing the build root and `try_files` directive

![alt text](screenshots/Wk7-A2-SS8-Build-Root.PNG)
...
![alt text](screenshots/Wk7-A2-SS9-React-App_Visible-Using-Public-IP.PNG)
...
![alt text](screenshots/Wk7-A2-SS10-SSH-Restricted.PNG)
